...
int main(int argc, char **argv)
{
    ...
    struct Mesh *meshes[] = {
        // mesh_alloc((Vec3f){ 0.f, 4.f, 0.f }, "res/ground.obj", (Vec3f){ .5f, .9f, .5f }),
        ...
        mesh_alloc((Vec3f){ -1.f, 3.4f, 12.f }, "res/monkeyt.obj", (Vec3f){ .95f, .7f, .95f }),
        mesh_alloc((Vec3f){ -.4f, 3.4f, 16.f }, "res/cylinder.obj", (Vec3f){ .95f, .7f, .7f }),

        // mesh_alloc((Vec3f){ -.4f, 3.4f, 16.f }, "res/left_ball.obj", (Vec3f){ .95f, .7f, .7f }),
        // mesh_alloc((Vec3f){ -.4f, 3.4f, 16.f }, "res/right_ball.obj", (Vec3f){ .95f, .7f, .7f }),
    };
